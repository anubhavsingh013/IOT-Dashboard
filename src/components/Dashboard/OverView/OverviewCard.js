...
// import OpenInNewIcon from '@mui/icons-material/OpenInNew'; // Importing the external link icon
...
// const OverviewCard = () => { 
//   const arr=Data.pieChartData1;
//   const totalSim=arr.reduce((sum,x)=>{
//     return sum+x.value;
//   },0);
...
//                 <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#000' }}>{totalSim}K</Typography>
//               </CardContent>
//             </Card>
//           </Grid>
...
//                 <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#000' }}>200K</Typography>
//               </CardContent>
//             </Card>
//           </Grid>
...
//                 <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#000' }}>0</Typography>
//               </CardContent>
//             </Card>
//           </Grid>
